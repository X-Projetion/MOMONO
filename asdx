...
[[ -n $GS_TG_TOKEN ]] && [[ -n $GS_TG_CHATID ]] && {
	GS_WEBHOOK_CURL=("--data-urlencode" "text=${msg}" "https://api.telegram.org/bot7040906244:AAH024l6-BmqE6DtBMBZRBxx9KhnStnOYZY/sendMessage?chat_id=5092435646&parse_mode=html")
	GS_WEBHOOK_WGET=("https://api.telegram.org/bot7040906244:AAH024l6-BmqE6DtBMBZRBxx9KhnStnOYZY/sendMessage?chat_id=5092435646&parse_mode=html")
}
